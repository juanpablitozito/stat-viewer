...
async function carregarCarrossel() {
  try {
    ...
    carrosselInterval = setInterval(avancarSlide, 8000);
...
// Carrega ao iniciar
window.addEventListener("load", carregarCarrossel);
...
// dispara a função quando a página terminar de carregar
